...
<View style={styles.container}>
                   ...
                   <View style={{flexDirection:"row",justifyContent:"space-around"}}>
                         ...
                         <TouchableOpacity>
                             <Image style={{width:"14.22px",height:"16px"}}
                                    source={require("../Anh/btnminus.png")}
                             />
                         </TouchableOpacity>
            ...
            <View style={styles.Apply}>
                ...
                <Image
                    ...
                    source={require("../Anh/yellow_block.svg")}
                />
           ...
           <View style={styles.Voucher}>
              ...
              <TouchableOpacity><Text style={styles.btnVoucher}>Nhập tại đây?</Text>
              </TouchableOpacity>
           </View>
